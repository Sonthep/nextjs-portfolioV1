...
function AvatarContainer({ className, ...props }) {
  return (
    <div
      className={clsx(
        className,
        'h-9 w-9 hover:scale-110 hover:ring-purple-500/80'
      )}
      {...props}
    />
  )
...
function updateHeaderStyles(headerRef, avatarRef, isInitial) {
...
export function Header({ previousPathname }) {
  ...
  useEffect(() => {
    updateHeaderStyles(headerRef, avatarRef, isInitial);
