          ...
          <Container.Inner>
            <div className="flex flex-col items-center justify-between gap-8 sm:flex-row">
              <div className="hidden gap-6 text-sm font-medium text-zinc-800 dark:text-zinc-200 md:flex">
                {/* <NavLink href="https://x.com/_sonthep">Twitter</NavLink> */}
                <NavLink href="https://github.com/Sonthep">GitHub</NavLink>
                {/* <NavLink href="https://www.linkedin.com/in/sonthep/">
                  LinkedIn
                </NavLink> */}
                <NavLink href="mailto:sonthep.simmalee@gmail.com">Mail</NavLink>
              </div>
              <div className="flex gap-x-12 md:hidden">
                {/* <SocialLinkMobile
                  href="https://x.com/sonthep"
                ...
                />
                {/* <SocialLinkMobile
                  href="https://www.linkedin.com/in/sonthep/"
                  aria-label="Follow on LinkedIn"
                  icon={FaLinkedinIn}
                /> */}
                <SocialLinkMobile
                  className="h-6 w-6"
                  href="mailto:sonthep.simmalee@gmail.com"
                  aria-label="Send an email"
                  icon={MdEmail}
                />
              </div>
              <p className="font-poppins text-sm tracking-wider text-zinc-400 dark:text-zinc-500">
                &copy; {new Date().getFullYear()} Sonthep Simmalee. All rights
                reserved.
              </p>
            </div>
          </Container.Inner>
